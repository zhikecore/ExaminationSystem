...
namespace DBUtility
{
    ...
    public class CourseSys
    {
        ...
        private static string strSqlConnection()
        {
            ...
            //server=.\MSSQLSERVER,1433;database=TMS;User ID=elearning;password=elearning;
        ...
        {
            SqlConnection sql = CourseSys.sql();
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SqlDataReader</returns>
        public static int ExecuteCount(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
