...
{
    public partial class Radio :Common.OLPage
    {
        /// <summary>
        /// 是否开卷
        /// </summary>
        ...
        {
            int PapersID = int.Parse(Request.QueryString["ID"]);
            Submit("单选", PapersID, gv_01);
            Submit("多选", PapersID, gv_02);
            Submit("不定项选", PapersID, gv_03);
            Submit("判断题", PapersID, gv_04);
            Submit("值选项", PapersID, gv_05);
