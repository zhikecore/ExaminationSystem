<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setup3.aspx.cs" Inherits="Web.Setup.Setup3" %>
                            ...
                            <div style="margin:10px" class="table_Box">
                                ...
                                <table class="text_12px" visible="false" runat="server" id="table_UserSys">
                                    ...
                                    <tr>
                                        <td>标识：</td>
                                        <td>
                                            <asp:Label ID="lb_Key_UserSys" runat="server" Text="CourseSys"></asp:Label>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
