<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertExam.aspx.cs" Inherits="Web.Setup.InsertExam" %>
                    ...
                    <tr>
                        <td style="background-image: url(/Images/admin_04.gif);" valign="top">
                            <div style="margin:10px">
                                <table class="text_12px" runat="server" id="table_UserSys">
                                    <tr>
                                        <td>服务器地址：</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="tb_Database_UserSys" runat="server" CssClass="table_Box" 
                                                ValidationGroup="UserSysList" Enabled="False">ExaminationSystem</asp:TextBox>
                                    ...
                                    <tr>
                                        <td>标识：</td>
                                        <td>
                                            <asp:Label ID="lb_Key_UserSys" runat="server" Text="试卷制作系统"></asp:Label>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
