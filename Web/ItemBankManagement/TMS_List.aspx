<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TMS.Master" AutoEventWireup="true" CodeBehind="TMS_List.aspx.cs" Inherits="Web.ItemBankManagement.TMS_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Title" runat="server">
题库管理：<%=Request.QueryString["TitleType"]%>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="Button" runat="server">
<a href="TMS_Add.aspx?TitleType=<%=Request.QueryString["TitleType"]%>"><img alt="添加" src="../Images/Add.jpg" border="0" /></a>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin:5px; float:left; width:100%">
        <asp:Label ID="lb_CourseTitle" runat="server" CssClass="title_14px"></asp:Label><asp:Label
            ID="Label1" runat="server" Text="0" Visible="false"></asp:Label>
    </div>
    ...
    <div style="margin:5px; float:left; width:100%">
        <asp:GridView ID="gv01" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        &nbsp;&nbsp;&nbsp;&nbsp;<img src="../Images/arrow.gif" alt="题目" />&nbsp;<a href="TMS_Details.aspx?TitleType=<%=Request.QueryString["TitleType"]%>&CourseID=<%=CourseID%>&ID=<%#Eval("ID") %>"><%#Eval("Title") %></a>
                        (<%#Eval("Extent")%>)
                    </ItemTemplate>
                </asp:TemplateField>
