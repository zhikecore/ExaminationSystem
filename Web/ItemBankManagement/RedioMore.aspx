<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedioMore.aspx.cs" Inherits="Web.ItemBankManagement.Redio1" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript">
        function addWorkExp() {
            ...
            txtWorkExp = txtWorkExp + "<td>&nbsp;<input type='checkbox' name='radio" + num + "' id='radio" + num + "' value='T' class='text_12px' />答案</td>";
        ...
        <tr>
            ...
            <table class="text_12px">
                <tr>
                    ...
                    <td>
                    &nbsp;<input type="checkbox" name="radio1" id="radio1" value="T" class="text_12px" />答案
                    </td>
                    <td></td>
                </tr>
            </table>
