<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Right.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Web.ItemBankManagement.Details" %>
...
<a href="List.aspx?TitleType=<%=Request.QueryString["TitleType"]%>&CourseID=<%=CourseID%>"><img alt="返回" src="../Images/Back.jpg" border="0" /></a>
</asp:Content>
