<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMS_Students.aspx.cs" Inherits="Web.ResultsManagement.TMS_Students" %>
                ...
                <td style="background-color:#FFFFFF" valign="top">
                    <asp:GridView ID="gv_01" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <input type="checkbox" value='<%# Eval("ID")%>' runat="server" onclick="fn_gv_01_checkbox(this.value)" id="gv_01_checkbox" title="查看成绩" />查看成绩
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
